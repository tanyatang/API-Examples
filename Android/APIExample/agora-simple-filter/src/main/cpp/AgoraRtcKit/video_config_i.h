...
#define SET_FROM(X) SetFrom(&X, change.X)
    ...
    SET_FROM(video_android_texture_copy_enable);
...
#define END_COMPARE()
    ...
    ADD_COMPARE(video_android_texture_copy_enable);
...
#define ADD_STRING(X) ost << ToStringIfSet(#X, X)
    ...
    ADD_STRING(video_android_texture_copy_enable);
...
#undef ADD_STRING
  ...
  Optional<bool> video_android_texture_copy_enable;
